...
import com.khoaluan.mxhgiaothong.customView.dialog.Interpolator.EaseInInterpolator;
import com.khoaluan.mxhgiaothong.customView.dialog.listener.CustomDialogActionListener;
import com.khoaluan.mxhgiaothong.customView.dialog.listener.CustomDialogAnimationListener;
...
public class BaseCustomDialogFragment extends AppCompatDialogFragment {
    ...
    * */
    ...
    private void setLayout() {
        float cornerRadius = getContext().getResources().getDimension(R.dimen.cornerRadius_dialog); //10dp
